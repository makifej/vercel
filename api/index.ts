...
app.post("/chat", async (req, res): Promise<any> => {
  ...
  const systemPrompt = `
        ...
        - "do pushups every 45 minutes" -> {"title": "Do pushups", "description": null, "intervalMinutes": 45, "isRepeating": true, "category": "fitness", "specificTime": null, "weekdays": null, "startDate": null, "endDate": null}
        ...
        - "do meditation every 1 minutes after 16:50 or 16.50" -> {"title": "Do Meditation", "description": null, "intervalMinutes": 1, "isRepeating": true, "category": "health", "specificTime": "null", "weekdays": null, "startDate": "01/07/2025 16:50", "endDate": null}
        - "drink water every 30 minutes from 12pm to 4pm" -> {"title": "Drink water", "description": null, "intervalMinutes": 30, "isRepeating": true, "category": "health", "specificTime": "null", "weekdays": null, "startDate": "01/07/2025 12:00", "endDate": "01/07/2025 16:00"}
        ...
        - "meeting tomorrow at 2:30 PM" -> {"title": "Meeting", "description": null, "intervalMinutes": null, "isRepeating": false, "category": "todo", "specificTime": "01/07/2025 14:30", "weekdays": null, "startDate": null, "endDate": null}
        - "call norbi on monday at 2:30 PM" -> {"title": "Call Norbi", "description": null, "intervalMinutes": null, "isRepeating": false, "category": "todo", "specificTime": "01/07/2025 14:30", "weekdays": null, "startDate": null, "endDate": null}
